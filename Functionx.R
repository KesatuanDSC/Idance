generate_completion <- function(user_prompt, tipe) {
  ...
  if(tipe == 'Regression'){
    ...
    sys_prompt <- "Jelaskan Hasil Clustering berdasarkan cluster yang terbentuk dengan dibuatkan poin tiap cluster serta usulkan juga nama atau tema yang tepat untuk masing-masing cluster dan berikan kesimpulannya serta hilangkan elemen boldnya setiap kalimat agar tidak tampil tanda **."
  } else if(tipe == 'Story'){
