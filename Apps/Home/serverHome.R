output$homeText <- renderText({
  glue::glue(
    ...
    <p>Platform ini dilengkapi tujuh modul utama, yaitu Interactive Clustering untuk pengelompokan data, Network Graph untuk visualisasi hubungan data, Regression untuk analisis prediktif, Fuzzy Duplicate untuk deteksi data duplikat, Benford Analysis untuk identifikasi anomali numerik, WhatsApp Analysis untuk analisis percakapan digital, dan Statistical Sampling untuk pemilihan sampel yang representatif.</p>
